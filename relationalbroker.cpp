...
void RelationalBroker::InitDataBase()
{
    ...
    try {
        ...
        Query("INSERT INTO Users "
              ...
              "(20000004, '代码敲到手抽筋', 'path', '男', '北京', '热爱生活，热爱编程'),"
              "(20000005, '熬夜冠军', 'path', '女', '上海', '追逐梦想，永不止步'),"
              "(20000006, '可乐不加冰', 'path', '男', '广州', '技术改变世界'),"
              "(20000007, '吃瓜群众', 'path', '女', '深圳', '代码如诗，逻辑如画'),"
              "(20000008, '香菜终结者', 'path', '男', '杭州', '探索未知，勇往直前'),"
              "(20000009, '量子波动速读', 'path', '女', '成都', '热爱美食，热爱生活'),"
              "(20000010, '404NotFound', 'path', '男', '武汉', '坚持不懈，终会成功'),"
              "(20000011, '深海孤鲸', 'path', '女', '西安', '历史与现代的交融'),"
              "(20000012, '迷雾森林', 'path', '男', '南京', '六朝古都，文化底蕴'),"
              "(20000013, '星空守望者', 'path', '女', '苏州', '园林之城，人间天堂'),"
              "(20000014, '幻夜星辰', 'path', '男', '天津', '海河之滨，魅力之城'),"
              "(20000015, '键盘侠本侠', 'path', '女', '重庆', '山城重庆，火锅之都'),"
              "(20000016, 'Bug制造机', 'path', '男', '长沙', '岳麓山下，橘子洲头'),"
              "(20000017, '阳光总在风雨后', 'path', '女', '郑州', '中原大地，文化之源'),"
              "(20000018, '月下独酌', 'path', '男', '青岛', '海滨之城，啤酒之都'),"
              "(20000019, '流年似水', 'path', '女', '大连', '浪漫之都，时尚之城')"
              ";");
